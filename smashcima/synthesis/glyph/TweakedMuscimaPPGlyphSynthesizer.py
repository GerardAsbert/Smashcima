...
from smashcima.assets.glyphs.muscima_pp.TweakedMuscimaPPGlyphs import TweakedMuscimaPPGlyphs
...
class TweakedMuscimaPPGlyphSynthesizer(GlyphSynthesizer):
    """Synthesizes glyphs by sampling from the MUSCIMA++ dataset"""
    
    def __init__(
        self,
        assets: AssetRepository,
        mpp_style_domain: TweakedMuscimaPPStyleDomain,
        rng: random.Random,
    ):
        bundle = assets.resolve_bundle(TweakedMuscimaPPGlyphs)
